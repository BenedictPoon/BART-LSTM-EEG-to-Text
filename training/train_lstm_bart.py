#!/usr/bin/env python3
"""
Training Script for LSTM-BART EEG to Text Translation

This script trains the LSTM-BART hybrid model for EEG to text translation.
"""
...
from models.lstm_bart import create_lstm_bart_model
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train LSTM-BART model for EEG to text translation')
    parser.add_argument('--config', type=str, default='configs/lstm_bart_config.yaml',
    ...
    # Create model
    logger.info("Creating LSTM-BART model...")
    model = create_lstm_bart_model(config['model'])
